...
public class Drivetrain extends Subsystem {
    ...
    //Specifically used for motionMagic
    //TODO Figure out the units used in these
    private int cruiseVel = 3000;
    ...
    public void velocityDrive(Joystick left, Joystick right){
        ...
        if(INVALID_INPUT == retval) {
            ...
            leftTalonLead.set(TalonFXControlMode.Velocity,(retval * maxRPM * .5));    
        }
        ...
        if(INVALID_INPUT == retval) {
            ...
            rightTalonLead.set(TalonFXControlMode.Velocity,(retval * maxRPM * .5));
        }
    }
    ...
    public void magicDrive(Joystick left, Joystick right){
        ...
        if(INVALID_INPUT == retval) {
            ...
            leftTalonLead.set(TalonFXControlMode.MotionMagic,(retval * maxRPM * .5));    
        }
        ...
        if(INVALID_INPUT == retval) {
            ...
            rightTalonLead.set(TalonFXControlMode.MotionMagic,(retval * maxRPM * .5));
        }
    }
