...
public class Drivetrain extends Subsystem {
    ...
    private final double TARGET_RIGHT_THRESHOLD = 1.0;
    private final double TARGET_LEFT_THRESHOLD = -1.0;
    ...
    // t stands for target
    private NetworkTableEntry tAquired;
    ...
    leftTalonLead.setInverted(TalonFXInvertType.CounterClockwise);
    rightTalonLead.setInverted(TalonFXInvertType.Clockwise);
    ...
    leftTalonLead.configSelectedFeedbackSensor(TalonFXFeedbackDevice.RemoteSensor0, 1, 4000);
    rightTalonLead.configSelectedFeedbackSensor(TalonFXFeedbackDevice.RemoteSensor0, 1, 4000);
    ...
    leftTalonLead.config_kF(1,vF,10);
    leftTalonLead.config_kP(1,vP,10);
    leftTalonLead.config_kI(1,vI,10);
    leftTalonLead.config_kD(1,vD,0);
