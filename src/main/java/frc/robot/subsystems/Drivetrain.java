...
private WPI_TalonSRX rightTalon;
    ...
    private TalonSRX leftTalonLead;
    //private TalonFX leftTalonFollower;
    private TalonSRX rightTalonLead;
...
rightTalon = new WPI_TalonSRX(1);
    ...
    public void dumbDrive(Joystick left, Joystick right) {
        ...
        if(INVALID_INPUT == retval) {
            ...
            leftTalonLead.set(ControlMode.PercentOutput, retval);    
        }
        ...
        if(INVALID_INPUT == retval) {
            ...
            rightTalonLead.set(ControlMode.PercentOutput, retval);    
        }   
    }
    ...
    public void velocityDrive(Joystick left, Joystick right){
        ...
        if(INVALID_INPUT == retval) {
            ...
            leftTalonLead.set(ControlMode.Velocity,retval * maxRPM);    
        }
        ...
        if(INVALID_INPUT == retval) {
            ...
            rightTalonLead.set(ControlMode.Velocity,retval * maxRPM);
        }
    }
