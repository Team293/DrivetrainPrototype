...
public class Drivetrain extends Subsystem {
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("leftEncoderVal", leftTalonLead.getSelectedSensorPosition());
        SmartDashboard.putNumber("rightEncoderVal", rightTalonLead.getSelectedSensorPosition());
    }
