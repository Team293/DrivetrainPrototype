...
public class Drivetrain extends Subsystem {
    ...
    public void periodic() {
        SmartDashboard.putNumber("leftEncoder",leftTalonLead.getSelectedSensorPosition());
        SmartDashboard.putNumber("rightEncoder",rightTalonLead.getSelectedSensorPosition());
    }
    ...
    public void dumbDrive(Joystick left, Joystick right) {
        ...
        if(INVALID_INPUT == retval) {
            ...
            rightTalonLead.set(TalonFXControlMode.PercentOutput,(retval * .5));    
        }   
    }
