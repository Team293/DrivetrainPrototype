...
public class Drivetrain extends Subsystem {
    ...
    private double kF = 0.;
    private double kP = .0001; // See above
    private double kI = 0.;
    private double kD = -0;
    ...
    private int cruiseVel = 3000; //TODO Figure out the units used in these
    ...
    public void velocityDrive(Joystick left, Joystick right){
        ...
        if(INVALID_INPUT == retval) {
            ...
            leftTalonLead.set(TalonFXControlMode.Velocity,(retval * maxRPM * speed));    
        }
        ...
        if(INVALID_INPUT == retval) {
            ...
            rightTalonLead.set(TalonFXControlMode.Velocity,(retval * maxRPM * speed));
        }
    }
    ...
    public void magicDrive(Joystick left, Joystick right){
        ...
        if(INVALID_INPUT == retval) {
            ...
            leftTalonLead.set(TalonFXControlMode.MotionMagic,(retval * maxRPM * speed));    
        }
        ...
        if(INVALID_INPUT == retval) {
            ...
            rightTalonLead.set(TalonFXControlMode.MotionMagic,(retval * maxRPM * speed));
        }
    }
