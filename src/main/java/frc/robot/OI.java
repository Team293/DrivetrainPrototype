...
public JoystickButton gripperOpenButton;
public JoystickButton gripperCloseButton;
...
armDownButton = new JoystickButton(rightJoy, 3);
armDownButton.whileHeld(new ArmDown());
armUpButton = new JoystickButton(rightJoy, 5);
armUpButton.whileHeld(new ArmUp());
leftJoy = new Joystick(0);

gripperCloseButton = new JoystickButton(leftJoy, 4);
gripperCloseButton.whenPressed(new GripperClose());
gripperOpenButton = new JoystickButton(leftJoy, 6);
